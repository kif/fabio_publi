...
adscimage   &   ADSC Quantum		&	.img	&	No	&	Yes		\\%Check\\
brukerimage &   Bruker formats		&	.sfrm	&	No	&	Yes		\\%TODO Complete\\
DM3			&	.dm3	&	?	&	?		\\%?\\
edfimage    &   ESRF data format	&	.edf	&	Yes	&	Yes		\\%Several bit formats\\
EDNA\cite(edna}-XML	&	.xml	&	No	&	No	 \\%Internaly used in EDNA\cite{edna}\\
cbfimage    &   CIF Binary Files	&	.cbf	&	No?	& 	Yes		\\%Used also by Pilatus \\
kcdimage    &   Nonius 	KappaCCD	&	.kccd	&	No 	&	No		\\%Multiples frames are merged are reading. now bruker\\
fit2dmaskimage \cite{fit2d} &   .msk    &   No  &   Yes  \\
fit2dspreadsheetimage \cite{fit2d}&   .spr    &   No  &   Yes    \\
GEimage     &   General Electric	&	-		&	Yes	&	No?		\\%massivly multi-frame\\
HiPiC       & Hamamatsu CCDs 		&	.tif	&	No	&	No?	 	\\%Tiff based format\\
marccdimage &   MarCCD/Mar165		&	.mccd	&	No	&	No?		\\%Tiff based format\\
mar345image &   Mar345				&	.mar3450		&	No	&	Yes		\\%Compressed format\\
OXDimage    &   Oxford Diffraction 	&	.img	&	No	&	Yes		\\%now Agilent\\
pilatusimage    & Dectris Pilatus		&	.tif	&	No?	&	No?		\\%Tiff based format\\
